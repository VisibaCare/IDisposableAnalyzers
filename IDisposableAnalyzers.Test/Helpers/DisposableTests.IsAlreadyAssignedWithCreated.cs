...
namespace N
{
    ...
    public class Disposable : IDisposable
    {
        public void Dispose()
        {
            ...
            Assert.AreEqual(false, Disposable.IsAlreadyAssignedWithCreated(value, semanticModel, IgnoredSymbols.Empty, CancellationToken.None, out _));
        }
...
namespace N
{
    ...
    public class Disposable : IDisposable
    {
        public void Dispose()
        {
            ...
            Assert.AreEqual(true, Disposable.IsAlreadyAssignedWithCreated(value, semanticModel, IgnoredSymbols.Empty, CancellationToken.None, out _));
        }
